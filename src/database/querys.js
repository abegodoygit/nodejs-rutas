export const queries= {
    ...
    getunidad:"select* from unidadDeTransporte",
    getunidadesLinea: "Select placa_ut, estado_ut from unidadDeTransporte where linea_ut=@num",
    getunidadByplaca: "Select* from unidadDeTransporte where placa_ut=@placa",
    addunidad:"Insert into unidadDeTransporte values(@placa,@year,@categ,@marca,@estado,@propiet,@capac,@tipo,@lati,@lngi,@linea)",
    ...
    updateunidad:"Update unidadDeTransporte set año_ut=@year,categ_ut=@categ,marca_ut=@marca,estado_ut=@estado,propietar_ut=@propiet,capac_ut=@capac,tipo_ut=@tipo where placa_ut=@id",
    deleteunidad: "Delete from unidadDeTransporte where placa_ut=@Id",
